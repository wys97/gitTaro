...
export default class AtGrid extends AtComponent {
  ...
  render() {
    ...
    return <View className={classNames('at-grid', this.props.className)}>
        {gridGroup.map((item, i) => <View className="at-grid__flex" key={i}>
            {item.map((childItem, index) => <View key={index} className={classNames(bodyClass, {
                ...
                <View className="at-grid-item__content">
                  <View className="at-grid-item__content-inner">
                    <View className="content-inner__icon">
                      ...
                      {_isObject(childItem.iconInfo) && !childItem.image && <Text className={classNames(childItem.iconInfo.prefixClass || 'at-icon', {
                  [`${childItem.iconInfo.prefixClass || 'at-icon'}-${childItem.iconInfo.value}`]: childItem.iconInfo.value
                }, childItem.iconInfo.className)} style={this.mergeStyle({
