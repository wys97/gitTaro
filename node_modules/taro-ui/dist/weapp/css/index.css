...
.at-checkbox {
  ...
  .at-checkbox__icon-cnt {
    ...
    font-size: 24rpx;
    line-height: 1;
    border: 2rpx solid rgba(97, 144, 232, 0.2);
    border-radius: 50%;
    background-color: #FFF;
    -webkit-box-sizing: border-box;
            box-sizing: border-box;
...
.at-fab {
  ...
  border-radius: 50%;
  background: #6190E8;
  -webkit-box-shadow: 0 6rpx 10rpx -2rpx rgba(0, 0, 0, 0.2), 0 12rpx 20rpx 0 rgba(0, 0, 0, 0.14), 0 2rpx 36rpx 0 rgba(0, 0, 0, 0.12);
          box-shadow: 0 6rpx 10rpx -2rpx rgba(0, 0, 0, 0.2), 0 12rpx 20rpx 0 rgba(0, 0, 0, 0.14), 0 2rpx 36rpx 0 rgba(0, 0, 0, 0.12);
  -webkit-box-sizing: border-box;
          box-sizing: border-box;
  /* elements */
  /* modifiers */ }
  .at-fab:active {
    background: #346FC2;
    -webkit-box-shadow: 0 14rpx 16rpx -8rpx rgba(0, 0, 0, 0.2), 0 24rpx 34rpx 4rpx rgba(0, 0, 0, 0.14), 0 10rpx 44rpx 8rpx rgba(0, 0, 0, 0.12);
            box-shadow: 0 14rpx 16rpx -8rpx rgba(0, 0, 0, 0.2), 0 24rpx 34rpx 4rpx rgba(0, 0, 0, 0.14), 0 10rpx 44rpx 8rpx rgba(0, 0, 0, 0.12); }
  .at-fab__icon,
  .at-fab .at-icon {
    width: 48rpx;
    height: 48rpx;
...
.at-search-bar {
  ...
  .at-search-bar__placeholder-wrap {
    ...
    vertical-align: middle;
    opacity: 1;
    -webkit-transition: -webkit-box-flex 0.3s, -webkit-flex 0.3s;
    transition: -webkit-box-flex 0.3s, -webkit-flex 0.3s;
    -o-transition: flex 0.3s;
    transition: flex 0.3s;
    transition: flex 0.3s, -webkit-box-flex 0.3s, -webkit-flex 0.3s, -ms-flex 0.3s; }
