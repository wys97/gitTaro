...
const makeConfig = (config) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (sass.resource && sass.projectDirectory) {
        ...
        const getBundleContent = (url) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (typeof resource === 'string') {
                yield getBundleContent(resource);
            }
            else if (Array.isArray(resource)) {
                for (const url of resource) {
                    yield getBundleContent(url);
                }
            }
        }
        catch (e) {
    ...
    return Object.assign({}, config, { plugins, sassLoaderOption: Object.assign({}, sassLoaderOption, { data: sassLoaderOption.data ? `${sassLoaderOption.data}${bundledContent}` : bundledContent }) });
});
